...
using SanderTenBrinke.EntityFrameworkCore.Extensions.SqlServer.DataMasking.Samples;
...
namespace EntityFrameworkCore.Extensions.SqlServer.DataMasking.Samples.Migrations
{
    ...
    [Migration("20250210132135_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameworkCore.Extensions.SqlServer.DataMasking.Samples.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityFrameworkCore.Extensions.SqlServer.DataMasking.Samples.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityFrameworkCore.Extensions.SqlServer.DataMasking.Samples.Order", b =>
                {
                    b.HasOne("EntityFrameworkCore.Extensions.SqlServer.DataMasking.Samples.Customer", null)
                        .WithMany("Orders")
